...
Ext.define("Phoenix.view.ScenarioGrid", {
  ...
  requires: ["Phoenix.controller.ScenarioGridController","Ext.grid.column.Number", "Ext.grid.column.Date", "Ext.grid.column.Action", "Ext.grid.plugin.BufferedRenderer"],
